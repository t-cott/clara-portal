  ...
  return (
    <AuthGuard allowedRole="client">
      <div className="flex h-screen bg-white">
        ...
        {/* Sidebar */}
        <aside
          className={`fixed inset-y-0 left-0 z-40 w-72 transform border-r border-slate-200 bg-slate-50 transition-transform duration-200 md:relative md:translate-x-0 ${
